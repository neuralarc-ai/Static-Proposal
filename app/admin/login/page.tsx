...
import { RiShieldLine, RiArrowRightLine } from 'react-icons/ri'
          ...
          <div className="flex gap-3 justify-center mb-8">
            {pin.map((digit, index) => (
              <input
                ...
                onPaste={handlePaste}
                disabled={loading}
                className="w-16 h-20 text-center text-2xl font-primary font-bold border-2 border-gray-300 rounded-lg focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                inputMode="numeric"
